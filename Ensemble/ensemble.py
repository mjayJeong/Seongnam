...
mclp_results = load_csv("mclp_result.csv")
pmedian_results = load_csv("pmedian_result.csv")
kmeans_results = load_csv("kmeans_result.csv")
...
for loc in final_locations:
    folium.Marker(
        ...
        tooltip=f"Votes: {loc['votes']} | 이름들: {', '.join(loc['이름들'])}",
